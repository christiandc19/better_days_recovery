...
import heroinImage from '../../../assets/alcohol_addiction.webp';
import ProgramOptionsMenu from '../../ProgramOptions/ProgramOptionsMenu/ProgramOptionsMenu';
        ...
        <div className='addiction-section-content'>
          ...
          <div className='addiction-section-caption'>
            ...
            <div className='addiction-section-header'>
              ...
              <p>        
                At Better Days Recovery Center, we specialize in comprehensive treatment programs for <strong>Alcohol Addiction</strong> and <strong>Heroin Addiction</strong>. Our goal is to provide effective recovery paths tailored to meet individual needs, helping you overcome addiction and regain control of your life.
              </p>
            </div>
            ...
            <div className='addiction-section-body'>
              ...
              <div className='addiction-section-flex flex-reverse'>
                ...
                <div className='addiction-section-flex-caption'>
                  <p>Heroin addiction is a serious, life-threatening condition, but our specialized rehab program can help. At Better Days Recovery Center, we offer a structured treatment plan that includes medical detoxification, intensive therapy, and support systems to ensure a full recovery.</p><br />
